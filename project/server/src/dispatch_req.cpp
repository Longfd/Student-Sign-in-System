	...
	unsigned char* reqdata)
{
	...
	case CLIENT_REQ_QUERY_CLASS:
		return queryClassInfo(thread_info, reqdata);
	...
	case CLIENT_REQ_JOIN_ACTIVITY:
		return stuSignIn(thread_info, reqdata);

	case CLIENT_REQ_QUERY_ACTIVITY:
		return queryActivity(thread_info, reqdata);

	case CLIENT_REQ_QUERY_SIGN:
		return querySignInfo(thread_info, reqdata);
